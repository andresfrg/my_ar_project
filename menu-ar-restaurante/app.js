...
// 🔥 Nuevo modelo AR para el Perro Caliente
const hotdogModel = {
  glb: "assets/models/perro-caliente.glb", // usa aquí el nombre real de tu archivo
...
const dishes = [
  ...
  // PLATOS FUERTES
  {
    ...
    model: defaultModel, // sigue usando el modelo de hamburguesa
  },
  {
    id: "perro-gourmet",
    category: "platos-fuertes",
    ...
    model: hotdogModel, // 👈 AQUÍ USAMOS EL NUEVO MODELO DEL PERRO-CALIENTE
  },
  {
    id: "pasta-pesto",
    category: "platos-fuertes",
